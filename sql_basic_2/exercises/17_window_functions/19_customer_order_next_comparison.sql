...
-- with the next order placed by the same customer.
-- Return:
-- order_id,
-- customer_id,
-- order_date,
...
caom.order_date,
caom.order_value,
caom.next_order_value,
(caom.next_order_value - caom.order_value) as difference_to_next_order
