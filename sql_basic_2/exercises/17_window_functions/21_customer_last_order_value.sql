...
-- together with the value of the customer's last order.
-- Return:
-- order_id,
-- customer_id,
-- order_date,
-- order_value,
-- customer_last_order_value
...
caom.order_date,
caom.order_value,
caom.customer_last_order_value
